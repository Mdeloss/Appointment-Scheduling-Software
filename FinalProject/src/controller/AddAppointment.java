...
/**This class controls the actions and functions of the AddAppointment view. */
...
//---------------------------------------------//
    ...
    public void onActionAddContact(ActionEvent event) {
        ...
        // Logical check and alert if null object selected
        if (selectedObj == null) {
            // Error dialog box
    ...
    public void onActionAddCustomer(ActionEvent event) {
        ...
        // This grabs the Customer ID and places it in the text box
    ...
    public void onActionAddUser(ActionEvent event) {
        ...
        // This grabs the User ID and places it in the text box
    ...
    public void onActionSaveAppointment(ActionEvent event) throws IOException{
        ...
        try {
            ...
            Query.insert(apptID, title, description, location, type, startTS, endTS, customerID, userID, contactID);
